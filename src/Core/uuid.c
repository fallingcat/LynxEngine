...
void snpuid(char *str, size_t size, new_uuid_t u) {
  int i;
  char *tmp = str;
...
/* format_uuid_v1 -- make a UUID from the timestamp, clockseq,
   and node ID */
static void format_uuid_v1(new_uuid_t* uuid, uint16_t clock_seq,
...
int uuid_create(new_uuid_t *uuid)
{
