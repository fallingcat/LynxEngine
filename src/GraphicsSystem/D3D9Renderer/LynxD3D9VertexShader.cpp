...
{	
	namespace GraphicsSystem 
	{
		...
		//  說明:   
		//-------------------------------------------------------------------------------------------------------
		CD3D9VertexShader::CD3D9VertexShader(CGraphicsSystem *pgs)
		: CVertexShader(pgs)
		{	
			m_lpVS = NULL;
		...
		//  說明:   
		//-------------------------------------------------------------------------------------------------------
		CD3D9VertexShader::~CD3D9VertexShader(void)
		{
			Release();
		}				
		//-------------------------------------------------------------------------------------------------------
		...
		//  說明:   
		//-------------------------------------------------------------------------------------------------------
		void CD3D9VertexShader::Release()
		{
			if (m_lpVS)
			{
				m_lpVS->Release();
		...
		//  說明:   
		//-------------------------------------------------------------------------------------------------------
		LYNXBOOL CD3D9VertexShader::LoadCompiledShader(CStream& fs, const LYNXCHAR *filename)
		{
			int								i;
			LYNXFILE						fp, *lpFile;		
			BYTE							*lpData;	
		...
		//  說明:   
		//-------------------------------------------------------------------------------------------------------
		LYNXBOOL CD3D9VertexShader::CompileShader(CStream& fs, const LYNXCHAR *filename, const LYNXCHAR *ver, const CArray<CRenderer::SHADERMACRO>* def, LYNXBOOL brecompile, LYNXBOOL bdebug) 
		{ 
			LYNXERRORNO				Ret;
			...
			CD3D9Include DefaultIncludeHandler;
		...
		//  說明:   
		//-------------------------------------------------------------------------------------------------------
		LYNXBOOL CD3D9VertexShader::vLoad(const LYNXCHAR *filename, const CArray<CRenderer::SHADERMACRO>* def, CStream* stream) 
		{ 
		...
		//  說明:   
		//-------------------------------------------------------------------------------------------------------
		LYNXBOOL CD3D9VertexShader::vCompile(const LYNXCHAR *filename, const LYNXCHAR *ver, const CArray<CRenderer::SHADERMACRO>* def, CStream* stream) 
		{ 
			return LYNX_FALSE; 
		}		
		//-------------------------------------------------------------------------------------------------------
		...
		//  說明:   
		//-------------------------------------------------------------------------------------------------------
		void CD3D9VertexShader::vSet() 
		{ 
			CD3D9Renderer* lpR = (CD3D9Renderer*)(m_lpGraphicsSystem->GetlpRenderer());
			lpR->GetlpD3DDevice()->SetVertexShader(m_lpVS);	
		}
		//-------------------------------------------------------------------------------------------------------
		//
		//  說明:   
		//-------------------------------------------------------------------------------------------------------
		void CD3D9VertexShader::vSetConstantF(const char *name, const float f) 
		{
			CD3D9Renderer* lpR = (CD3D9Renderer*)(m_lpGraphicsSystem->GetlpRenderer());
		...
		//  說明:   
		//-------------------------------------------------------------------------------------------------------
		void CD3D9VertexShader::vSetConstantF(const char *name, const float *lpdata, int num) 
		{
			CD3D9Renderer* lpR = (CD3D9Renderer*)(m_lpGraphicsSystem->GetlpRenderer());
		...
		//  說明:   
		//-------------------------------------------------------------------------------------------------------
		void CD3D9VertexShader::vSetConstantI(const char *name, const int i) 
		{
			CD3D9Renderer* lpR = (CD3D9Renderer*)(m_lpGraphicsSystem->GetlpRenderer());
		...
		//  說明:   
		//-------------------------------------------------------------------------------------------------------
		void CD3D9VertexShader::vSetConstantI(const char *name, const int *lpdata, int num) 
		{
			CD3D9Renderer* lpR = (CD3D9Renderer*)(m_lpGraphicsSystem->GetlpRenderer());
		...
		//  說明:   
		//-------------------------------------------------------------------------------------------------------
		void CD3D9VertexShader::vSetConstantB(const char *name, const BOOL b) 
		{
			CD3D9Renderer* lpR = (CD3D9Renderer*)(m_lpGraphicsSystem->GetlpRenderer());
		...
		//  說明:   
		//-------------------------------------------------------------------------------------------------------
		void CD3D9VertexShader::vSetConstantB(const char *name, const BOOL *lpdata, int num) 
		{
			CD3D9Renderer* lpR = (CD3D9Renderer*)(m_lpGraphicsSystem->GetlpRenderer());
		...
		//  說明:   
		//-------------------------------------------------------------------------------------------------------
		void CD3D9VertexShader::vSetConstantV2(const char *name, const float* f) 
		{
			CD3D9Renderer* lpR = (CD3D9Renderer*)(m_lpGraphicsSystem->GetlpRenderer());
		...
		//  說明:   
		//-------------------------------------------------------------------------------------------------------
		void CD3D9VertexShader::vSetConstantV2(const char *name, const float *lpdata, int num) 
		{
			CD3D9Renderer* lpR = (CD3D9Renderer*)(m_lpGraphicsSystem->GetlpRenderer());
		...
		//  說明:   
		//-------------------------------------------------------------------------------------------------------
		void CD3D9VertexShader::vSetConstantV3(const char *name, const float* f) 
		{
			CD3D9Renderer* lpR = (CD3D9Renderer*)(m_lpGraphicsSystem->GetlpRenderer());
		...
		//  說明:   
		//-------------------------------------------------------------------------------------------------------
		void CD3D9VertexShader::vSetConstantV3(const char *name, const float *lpdata, int num) 
		{
			CD3D9Renderer* lpR = (CD3D9Renderer*)(m_lpGraphicsSystem->GetlpRenderer());
		...
		//  說明:   
		//-------------------------------------------------------------------------------------------------------
		void CD3D9VertexShader::vSetConstantV4(const char *name, const float* f) 
		{
			CD3D9Renderer* lpR = (CD3D9Renderer*)(m_lpGraphicsSystem->GetlpRenderer());
		...
		//  說明:   
		//-------------------------------------------------------------------------------------------------------
		void CD3D9VertexShader::vSetConstantV4(const char *name, const float *lpdata, int num) 
		{
			CD3D9Renderer* lpR = (CD3D9Renderer*)(m_lpGraphicsSystem->GetlpRenderer());
		...
		//  說明:   
		//-------------------------------------------------------------------------------------------------------
		void CD3D9VertexShader::vSetConstantM(const char *name, LPCLYNXMATRIX lpm) 
		{
			CD3D9Renderer* lpR = (CD3D9Renderer*)(m_lpGraphicsSystem->GetlpRenderer());
		...
		//  說明:   
		//-------------------------------------------------------------------------------------------------------
		void CD3D9VertexShader::vSetConstantM(const char *name, LPCLYNXMATRIX lpm, int num) 
		{
			CD3D9Renderer* lpR = (CD3D9Renderer*)(m_lpGraphicsSystem->GetlpRenderer());
		...
		//  說明:   
		//-------------------------------------------------------------------------------------------------------
		void CD3D9VertexShader::vSetTexture(const int channel, CTexture* t)  
		{
			if (channel >= 0)
			{			
		...
		//  說明:   
		//-------------------------------------------------------------------------------------------------------
		void CD3D9VertexShader::vSetTexture(const char *name, CTexture* t)  
		{
		...
		//  說明:   
		//-------------------------------------------------------------------------------------------------------
		void CD3D9VertexShader::vSetSampler(const char *name, CSamplerState* lps)
		{ 
		...
		//  說明:   
		//-------------------------------------------------------------------------------------------------------
		int CD3D9VertexShader::vGetTextureIndex(const char *name)
		{
