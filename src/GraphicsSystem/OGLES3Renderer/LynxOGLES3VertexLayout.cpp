...
{	
	namespace GraphicsSystem 
	{
		...
		//  說明:   
		//-------------------------------------------------------------------------------------------------------
		const LYNXANSICHAR* COGLES3VertexLayout::TranslateSlotName(CRenderer::VERTEXSLOT& slot)
		{
			switch (slot.Type)
			{
		...
		//  說明:   
		//-------------------------------------------------------------------------------------------------------
		COGLES3VertexLayout::COGLES3VertexLayout(CGraphicsSystem* pgs)
		: CVertexLayout(pgs)
		{
			m_Stride = 0;		
		...
		//  說明:   
		//-------------------------------------------------------------------------------------------------------
		COGLES3VertexLayout::~COGLES3VertexLayout()
		{			
			m_Stride = 0;
			m_AttributeArray.clear();
		}				
		...
		//  說明:   
		//-------------------------------------------------------------------------------------------------------
		LYNXBOOL COGLES3VertexLayout::vCreate(CRenderer::VERTEXSLOT* vs, int num, const LYNXCHAR* layoutname, const LYNXCHAR* vsname)
		{
			for (int i=0; i<num; i++)
		...
		//  說明:   
		//-------------------------------------------------------------------------------------------------------
		void COGLES3VertexLayout::GetVertexSlotOffset(int i, int* offset)
		{			
		...
		//  說明:   
		//-------------------------------------------------------------------------------------------------------
		LYNXBOOL COGLES3VertexLayout::vCreate(const LYNXCHAR* layoutname, const LYNXCHAR* vsname)
		{	
			int Offset = 0;
			for (int i=0; i<m_VertexSlots.size(); i++)
			{	
				OGLES3VertexAttribute Attrib;			
				Attrib.Attribute = i;
				Attrib.Type = COGLES3Renderer::TranslateVertexSlotFormat(m_VertexSlots[i].Format);
		...
		//  說明:   
		//-------------------------------------------------------------------------------------------------------
		void COGLES3VertexLayout::Bind(GLuint program)
		{			
			COGLES3Renderer* lpR = (COGLES3Renderer*)(m_lpGraphicsSystem->GetlpRenderer());
