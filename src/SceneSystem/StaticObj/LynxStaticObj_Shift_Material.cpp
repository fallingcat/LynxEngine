#include <SceneSystem/StaticObj/LynxStaticObj_Shift_Material.h>
...
{	
	namespace SceneSystem 
	{
		...
		//  說明:   
		//-------------------------------------------------------------------------------------------------------
		CStaticObjShiftMaterial::CStaticObjShiftMaterial(void)
		{	
			m_Time = 0.0f;
			m_UShiftSpeed = -0.001f;
			m_VShiftSpeed = 0.0f;			
		}
		//-------------------------------------------------------------------------------------------------------
		//
		...
		//  說明:   
		//-------------------------------------------------------------------------------------------------------
		void CStaticObjShiftMaterial::vLoad(LPLYNXFILE lpf)
		{		
			Create(1);
			...
			m_lpMaterialPass[0].ZBufferMode = LYNX_ZB_C;
			m_lpMaterialPass[0].bUseFog = LYNX_TRUE;	
			lynxLoadCompiledVertexShader(&m_lpMaterialPass[0].VS, lynxGetRenderVertexDecl(), "buildin/scn/staticobj_shift.vso", NULL, 0);		
		...
		//  說明:   
		//-------------------------------------------------------------------------------------------------------
		void CStaticObjShiftMaterial::vPlayAll(LYNXREAL skip, LYNXPLAYMODE pm)
		{
		...
		//  說明:   
		//-------------------------------------------------------------------------------------------------------
		void CStaticObjShiftMaterial::vSetParameter(void)
		{		
			SET_VS_PARAMETER(m_lpMaterialPass[0].VS, m_UShiftSpeed, 1);
			SET_VS_PARAMETER(m_lpMaterialPass[0].VS, m_VShiftSpeed, 1);
			SET_VS_PARAMETER(m_lpMaterialPass[0].VS, m_Time, 1);			
		}		
	}
}