...
{	
	namespace Shader
	{
		...
		//  說明:   
		//-------------------------------------------------------------------------------------------------------
		CDirectionalBlurPS::CDirectionalBlurPS(GraphicsSystem::CGraphicsSystem *pgs)
		: CShaderClass(pgs)
		{	
			m_BlurDir_Const = NULL;
			m_BlurDir.x = 0.0f;
			m_BlurDir.y = 1.0f;
			m_Distance = 0.1f;
			m_Weight = 1.0f;			
		...
		//  說明:   
		//-------------------------------------------------------------------------------------------------------
		CDirectionalBlurPS::~CDirectionalBlurPS(void)
		{
			if (m_BlurDir_Const)
		...
		//  說明:   
		//-------------------------------------------------------------------------------------------------------
		LYNXBOOL CDirectionalBlurPS::vCreate() 
		{ 
		...
		//  說明:   
		//-------------------------------------------------------------------------------------------------------
		void CDirectionalBlurPS::vCreateConstantAndResource() 
		{ 
			if (!m_BlurDir_Const)
		...
		//  說明:   
		//-------------------------------------------------------------------------------------------------------
		void CDirectionalBlurPS::vSet(CContainer* lpc, CCameraContainer* cam) 
		{ 			
