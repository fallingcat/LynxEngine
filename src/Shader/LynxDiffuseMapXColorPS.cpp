...
{	
	namespace Shader
	{
		...
		//  說明:   
		//-------------------------------------------------------------------------------------------------------
		CDiffuseMapXColorPS::CDiffuseMapXColorPS(GraphicsSystem::CGraphicsSystem *pgs)
		: CShaderClass(pgs)
		{	
		...
		//  說明:   
		//-------------------------------------------------------------------------------------------------------
		CDiffuseMapXColorPS::~CDiffuseMapXColorPS(void)
		{
		...
		//  說明:   
		//-------------------------------------------------------------------------------------------------------
		LYNXBOOL CDiffuseMapXColorPS::vCreate() 
		{ 
		...
		//  說明:   
		//-------------------------------------------------------------------------------------------------------
		void CDiffuseMapXColorPS::vCreateConstantAndResource() 
		{
			if (!m_ConstantColor_Const)
		...
		//  說明:   
		//-------------------------------------------------------------------------------------------------------
		void CDiffuseMapXColorPS::vSet(CContainer* lpc, CCameraContainer* cam) 
		{ 	
