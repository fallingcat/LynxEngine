...
#include <Shader/LynxVoxelClusterOneLightingSpecularVS.h>
...
{	
	namespace Shader
	{
		...
		//  說明:   
		//-------------------------------------------------------------------------------------------------------
		CVoxelClusterOneLightingSpecularVS::CVoxelClusterOneLightingSpecularVS(GraphicsSystem::CGraphicsSystem *pgs)
		...
		//  說明:   
		//-------------------------------------------------------------------------------------------------------
		CVoxelClusterOneLightingSpecularVS::~CVoxelClusterOneLightingSpecularVS(void)
		{
			if (m_CameraPos)
		...
		//  說明:   
		//-------------------------------------------------------------------------------------------------------
		LYNXBOOL CVoxelClusterOneLightingSpecularVS::vCreate() 
		{ 
		...
		//  說明:   
		//-------------------------------------------------------------------------------------------------------
		void CVoxelClusterOneLightingSpecularVS::vCreateConstantAndResource() 
		{ 
		...
		//  說明:   
		//-------------------------------------------------------------------------------------------------------
		void CVoxelClusterOneLightingSpecularVS::vSet(CContainer* lpc, CCameraContainer* cam) 
		{ 
