...
#include <Shader/LynxVoxelColorFakeAOLevel2SpecularPS.h>
...
{	
	namespace Shader
	{
		...
		//  說明:   
		//-------------------------------------------------------------------------------------------------------
		CVoxelColorFakeAOLevel2SpecularPS::CVoxelColorFakeAOLevel2SpecularPS(GraphicsSystem::CGraphicsSystem *pgs)
		: CVoxelColorPS(pgs)
		{	
		}
		//-------------------------------------------------------------------------------------------------------
		...
		//  說明:   
		//-------------------------------------------------------------------------------------------------------
		CVoxelColorFakeAOLevel2SpecularPS::~CVoxelColorFakeAOLevel2SpecularPS(void)
		{
		}						
		//-------------------------------------------------------------------------------------------------------
		//
		//  說明:   
		//-------------------------------------------------------------------------------------------------------
		LYNXBOOL CVoxelColorFakeAOLevel2SpecularPS::vCreate() 
		{ 
