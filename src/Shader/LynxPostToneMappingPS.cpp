...
{	
	namespace Shader
	{
		...
		//  說明:   
		//-------------------------------------------------------------------------------------------------------
		CPostToneMappingPS::CPostToneMappingPS(GraphicsSystem::CGraphicsSystem *pgs)
		: CShaderClass(pgs)
		{	
		...
		//  說明:   
		//-------------------------------------------------------------------------------------------------------
		CPostToneMappingPS::~CPostToneMappingPS(void)
		{
			if (m_Exposure_Const)
		...
		//  說明:   
		//-------------------------------------------------------------------------------------------------------
		LYNXBOOL CPostToneMappingPS::vCreate() 
		{ 
			return m_lpGraphicsSystem->GetlpRenderer()->LoadPixelShader(m_lpShader, _T("scn/post_tonemapping.pso"), &m_ShaderMacros);
		}
		//-------------------------------------------------------------------------------------------------------
		//
		//  說明:   
		//-------------------------------------------------------------------------------------------------------
		void CPostToneMappingPS::vCreateConstantAndResource() 
		{ 
			if (!m_Exposure_Const)
		...
		//  說明:   
		//-------------------------------------------------------------------------------------------------------
		void CPostToneMappingPS::vSet(CContainer* lpc, CCameraContainer* cam) 
		{ 			
			GraphicsSystem::CRenderer* lpR = m_lpGraphicsSystem->GetlpRenderer();			

			m_Exposure_Const->vMap();
				m_Exposure_Const->vSetFloat(cam->m_Exposure/4.0f);										
