...
#ifndef __LYNXCONTROLFACTORY_H__
#define __LYNXCONTROLFACTORY_H__
...
{
	class LYNXENGCLASS CControlFactory : public CFactory<GUISystem::CControl, CString, CEngine*>
	{	
	...
	public:			
		...
		{
			GUISystem::CControl* lpC = CFactory<GUISystem::CControl, CString, CEngine*>::CreateObject(id);
			m_ControlList.push_back(lpC);
