...
#ifndef __LYNXMOTIONINPUT_H__
#define __LYNXMOTIONINPUT_H__
...
namespace LynxEngine 
{
	namespace InputSystem 
	{
		namespace iOS
		{
			class LYNXENGCLASS CMotionInput : public CInputDevice
			{
				LYNX_DECLARE_CLASS(CMotionInput);
			protected:
				Math::CReal						m_HighPassFactor;	
				Math::CVector3					m_Value;
				Math::CVector3					m_HighPassValue;
			public:						
				CMotionInput(CInputSystem* lpsys);
				~CMotionInput();			
