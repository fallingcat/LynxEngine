...
#ifndef __LYNXRIGIDMODELVS_H__
#define __LYNXRIGIDMODELVS_H__
...
{	
	namespace Shader 
	{		
		class LYNXENGCLASS CRigidModelVS : public GraphicsSystem::CShaderClass
		{	
			LYNX_DECLARE_CLASS(CRigidModelVS);
		public:						
		protected:	
		...
		public:			
			CRigidModelVS(GraphicsSystem::CGraphicsSystem* lpg);
			virtual ~CRigidModelVS();
