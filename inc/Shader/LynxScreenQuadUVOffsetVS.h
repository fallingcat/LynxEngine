...
#ifndef __LYNXSCREENQUADUVOFFSETVS_H__
#define __LYNXSCREENQUADUVOFFSETVS_H__
...
{	
	namespace Shader 
	{		
		class LYNXENGCLASS CScreenQuadUVOffsetVS : public GraphicsSystem::CShaderClass
		{	
			LYNX_DECLARE_CLASS(CScreenQuadUVOffsetVS);
		public:			
			LYNXUVPOINT							m_UVOffset[4];
		protected:					
			GraphicsSystem::CShaderConstant*	m_UVOffset_Const;
		public:			
			CScreenQuadUVOffsetVS(GraphicsSystem::CGraphicsSystem* lpg);
			virtual ~CScreenQuadUVOffsetVS();
