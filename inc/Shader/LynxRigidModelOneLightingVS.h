...
#ifndef __LYNXRIGIDMODELONELIGHTINGVS_H__
#define __LYNXRIGIDMODELONELIGHTINGVS_H__
...
{	
	namespace Shader 
	{		
		class LYNXENGCLASS CRigidModelOneLightingVS : public GraphicsSystem::CShaderClass
		{	
			LYNX_DECLARE_CLASS(CRigidModelOneLightingVS);
		public:						
		protected:					
		...
		public:			
			CRigidModelOneLightingVS(GraphicsSystem::CGraphicsSystem* lpg);
			virtual ~CRigidModelOneLightingVS();
