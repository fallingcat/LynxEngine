...
#ifndef __LYNXGEOMETRYVS_H__
#define __LYNXGEOMETRYVS_H__
...
{	
	namespace Shader 
	{		
		class LYNXENGCLASS CGeometryVS : public GraphicsSystem::CShaderClass
		{	
			LYNX_DECLARE_CLASS(CGeometryVS);
		public:						
		protected:		
		...
		public:			
			CGeometryVS(GraphicsSystem::CGraphicsSystem* lpg);
			virtual ~CGeometryVS();
