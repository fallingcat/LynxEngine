...
#ifndef __LYNXANDROIDENGINE_H__
#define __LYNXANDROIDENGINE_H__
...
namespace LynxEngine 
{
	namespace Android
	{
		...
		public:					
		protected:				
			//InputSystem::iOS::CTouch*						m_lpSystemTouch;
			//InputSystem::iOS::CAccelerometer*				m_lpSystemAccelerometer;
			//InputSystem::iOS::CMotionInput*					m_lpSystemMotionInput;
		...
		public:		
			...
			virtual LYNXBOOL								vInit(LYNXWINDOW &win, const int w = 0, const int h = 0);			
			...
			//LYNXFORCEINLINE InputSystem::iOS::CTouch*		GetlpSystemTouch() const { return m_lpSystemTouch; };
			//LYNXFORCEINLINE InputSystem::iOS::CAccelerometer* GetlpSystemAccelerometer() const { return m_lpSystemAccelerometer; };
			//LYNXFORCEINLINE InputSystem::iOS::CMotionInput* GetlpSystemMotionInput() const { return m_lpSystemMotionInput; };
