...
#ifndef __LYNXANDROIDAPPSFLYERALYTICS_H__
#define __LYNXANDROIDAPPSFLYERALYTICS_H__
...
namespace LynxEngine
{
    namespace Android
	{
		class LYNXENGCLASS CAppsFlyerAnalytics
		{
			LYNX_DECLARE_CLASS(CAppsFlyerAnalytics);
		public:
		protected:
		public:
			CAppsFlyerAnalytics();
			...
			static void						Init(const CString& key);
			...
			static void						AddEvent(const CString& eventname);
		};
	}
}
