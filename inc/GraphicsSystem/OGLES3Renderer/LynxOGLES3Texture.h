...
#ifndef __LYNXOGLES3TEXTURE_H__
#define __LYNXOGLES3TEXTURE_H__
...
{	
	...
	{		
		class LYNXENGCLASS COGLES3Texture : public CTexture
		{
			LYNX_DECLARE_CLASS(COGLES3Texture);
		protected:	
			GLuint							m_GLHandle;
			int								m_Width;
			int								m_Height;
		...
		public:						
			COGLES3Texture(CGraphicsSystem* lpsys);
