...
#ifndef __LYNXOGLES3PIXELSHADER_H__
#define __LYNXOGLES3PIXELSHADER_H__
...
{	
	...
	{		
		class LYNXENGCLASS COGLES3PixelShader : public CPixelShader
		{
			LYNX_DECLARE_CLASS(COGLES3PixelShader);
		protected:			
			GLuint							m_GLHandle;
			GLuint							m_Program;
			COGLES3ShaderGroup*				m_lpShaderGroup;
		public:						
			COGLES3PixelShader(CGraphicsSystem* lpsys);
			virtual ~COGLES3PixelShader();
