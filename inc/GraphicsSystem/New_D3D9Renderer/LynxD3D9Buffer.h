...
{	
	...
	{		
		...
		public:						
			...
			void*							vLock(int flag, LPLYNXRECT lprect = NULL); 
			void							vUnlock();
			...
			void							vPrintf(LPLYNXRECT lprect, int x, int y, LPLYNXCOLORRGBA c, LYNXCHAR const *fmt, ...); 
			void							vPrintf(LPLYNXRECT lprect, int x, int y, LPLYNXCOLORRGBA c, LPLYNXCOLORRGBA sc, LYNXCHAR const *fmt, ...); 
		};		
	}		
}
