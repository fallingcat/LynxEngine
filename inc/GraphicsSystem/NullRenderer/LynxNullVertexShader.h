...
#ifndef __LYNXNULLVERTEXSHADER_H__
#define __LYNXNULLVERTEXSHADER_H__
...
{	
	...
	{		
		class LYNXENGCLASS CNullVertexShader : public CVertexShader
		{
			LYNX_DECLARE_CLASS(CNullVertexShader);
		protected:
		public:						
			CNullVertexShader(CGraphicsSystem* lpsys):CVertexShader(lpsys) {};
			virtual ~CNullVertexShader() {};
