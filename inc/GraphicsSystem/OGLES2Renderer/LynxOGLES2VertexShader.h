...
#ifndef __LYNXOGLES2VERTEXSHADER_H__
#define __LYNXOGLES2VERTEXSHADER_H__
...
{	
	...
	{		
		class COGLES2ShaderGroup;
		class LYNXENGCLASS COGLES2VertexShader : public CVertexShader
		{
			LYNX_DECLARE_CLASS(COGLES2VertexShader);
		protected:
			GLuint							m_GLHandle;
			GLuint							m_Program;
			COGLES2ShaderGroup*				m_lpShaderGroup;	
		public:						
			COGLES2VertexShader(CGraphicsSystem* lpsys);
			virtual ~COGLES2VertexShader();
