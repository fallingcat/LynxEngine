...
#ifndef __LYNXOGLES2QUERY_H__
#define __LYNXOGLES2QUERY_H__
...
{	
	...
	{		
		class LYNXENGCLASS COGLES2Query : public CQuery
		{
			LYNX_DECLARE_CLASS(COGLES2Query);
		protected:
		public:						
			COGLES2Query(CGraphicsSystem* lpgs):CQuery(lpgs) {};
			virtual ~COGLES2Query() {};				
