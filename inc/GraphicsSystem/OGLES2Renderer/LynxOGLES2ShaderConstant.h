...
#ifndef __LYNXOGLES2SHADERCONSTANT_H__
#define __LYNXOGLES2SHADERCONSTANT_H__
...
{	
	...
	{		
		class LYNXENGCLASS COGLES2ShaderConstant : public CShaderConstant
		{	
			LYNX_DECLARE_CLASS(COGLES2ShaderConstant);
		public:						
		protected:	
			GLint								m_Location;
		public:			
			COGLES2ShaderConstant(CShader* lps, const char* name);
			virtual ~COGLES2ShaderConstant();
